...
from rebbit.activities import views as activities_views
from rebbit.authentication import views as rebbit_auth_views
from rebbit.core import views as core_views
from rebbit.search import views as search_views
...
urlpatterns = [
    ...
    url(r'^signup/$', rebbit_auth_views.signup, name='signup'),
    ...
    url(r'^feeds/', include('rebbit.feeds.urls')),
    url(r'^questions/', include('rebbit.questions.urls')),
    url(r'^articles/', include('rebbit.articles.urls')),
    url(r'^messages/', include('rebbit.messenger.urls')),
