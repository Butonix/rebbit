...
from rebbit.settings import ALLOWED_SIGNUP_DOMAINS
...
class SignUpForm(forms.ModelForm):
    username = forms.CharField(
        ...
        max_length=30,
        required=True,
        help_text='Username may contain <strong>alphanumeric</strong>, <strong>_</strong> and <strong>.</strong> characters.')  # noqa: E501
    password = forms.CharField(
        widget=forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': 'Password'}))
    confirm_password = forms.CharField(
        widget=forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': 'Verify password'}),
    ...
    email = forms.CharField(
        ...
        required=True,
        max_length=75,
        help_text='This email address will be used to <strong>recover</strong> your account.')
