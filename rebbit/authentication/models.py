...
from rebbit.activities.models import Notification
...
class Profile(models.Model):
    ...
    dp_link = models.URLField(max_length=2000, null=True, blank=True)
    ...
    def get_picture(self):
        no_picture = 'https://www.shareicon.net/data/128x128/2016/05/29/772558_user_512x512.png'
        try:
